...
// Clue: the name is same as the text content of the button. Will be useful later on :)
var ingredients = {
  Patty: 80,
  Cheese: 10,
  Tomatoes: 20,
...
// This function renders the entire screen everything the state changes accordingly
function renderAll() {
  renderPatty();
  renderCheese();
  renderTomatoes();
...
function renderPrice() {
  ...
  document.querySelector(".price-details").innerHTML = price;
}